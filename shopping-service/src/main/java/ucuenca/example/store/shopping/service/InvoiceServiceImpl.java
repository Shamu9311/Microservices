...
import ucuenca.example.store.shopping.client.CustomerClient;
import ucuenca.example.store.shopping.client.ProductClient;
...
import ucuenca.example.store.shopping.repository.InvoiceItemsRepository;
import ucuenca.example.store.shopping.repository.InvoiceRepository;
